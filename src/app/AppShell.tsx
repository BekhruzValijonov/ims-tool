 ...
 * Оболочка приложения.
 *
 * Разметка дизайн-системы Minimal: светлая боковая панель с пунктирной
 * границей, прозрачная шапка с размытием, блок оператора на мягкой подложке.
 * Шапка не декоративная — в ней то, что кладовщик делает чаще всего: поиск
 * прибора по инвентарному номеру.
 */
