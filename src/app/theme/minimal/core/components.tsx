/*
 * Перенесено из проекта dashboard-ui без изменений, кроме двух мест: там MUI 7,
 * здесь MUI 9, и часть ключей переопределений переехала. Правки помечены
 * комментарием «MUI 9».
 */
...
const MuiButton: Components<Theme>['MuiButton'] = {
  ...
  // MUI 9: ключ containedInherit удалён, то же правило выражается вариантом.
  variants: [
    {
      ...
      style: ({ theme }: { theme: Theme }) => ({
        ...
        // grey[800] is the paper colour in dark mode, so the button has to invert
...
const MuiCardHeader: Components<Theme>['MuiCardHeader'] = {
  // MUI 9: titleTypographyProps/subheaderTypographyProps заменены на slotProps.
  defaultProps: {
    slotProps: {
      title: { variant: 'h6' },
