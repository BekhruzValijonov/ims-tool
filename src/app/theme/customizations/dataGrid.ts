...
// Побочный импорт: он добавляет MuiDataGrid в карту компонентов темы, иначе
// TypeScript не знает такого ключа и параметры функций остаются нетипизированными.
